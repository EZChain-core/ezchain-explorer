...
const description = 'EZChain Explorer is an analytics tool that enables people to search the EZChain blockchain for transactions, addresses, and other platform activities.';
const metaTags = [
    {
        name: 'description',
        content: description,
...
const routes = [
    ...
    },
    {
        path: '/evmblock/:id',
        name: 'EVM Block',
        component: () => import(/* webpackChunkName: "evmblock" */ '../views/EVMBlock.vue'),
        meta: {
            auth: false,
            title: prefix + 'Block',
            metaTags: metaTags,
    ...
    },
    {
        ...
        beforeEnter() {
            const NETWORK_ID = parseInt(process.env.VUE_APP_DEFAULT_NETWORKID || '1');
