...
const AGGREGATES_V2_API_BASE_URL = process.env.VUE_APP_AGGREGATES_V2_API_BASE_URL;
const ASSET_AGGREGATES_V2_API_BASE_URL = process.env.VUE_APP_ASSET_AGGREGATES_V2_API_BASE_URL;
/**
 * @param param time interval (1m, 24h, 30d...)
 * @returns time-series of aggregate data
 */
export function getAggregates(param) {
    return api
