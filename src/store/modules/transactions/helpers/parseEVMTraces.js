...
// adds props for UI
function dressTrace(trace, txInput) {
    return {
        ...trace,
        children: [],
...
export function parseEVMTraces(traces, txInput) {
    if (!traces)
        return [];
    const graph = [];
    ...
    const grapher = (root, currentValue) => {
        ...
        const beforeLast = currentValue.traceAddress[currentValue.traceAddress.length - 1 - 1];
...
//# sourceMappingURL=parseEVMTraces.js.map